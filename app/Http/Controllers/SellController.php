...
class SellController extends Controller
{
    ...
    public function create()
    {
        ...
        //vessel
        $vessel = [];
        //if ($this->moduleUtil->isModuleEnabled('vessel')) {
            $vessel = Vessel::forDropdown($business_id);
        //}
    ...
    public function getVesselCalculation(Request $request)
    {
        //dd($request->all());
      $data = Vessel::findOrFail($request->id);
      $arrival_date = new DateTime($data->arrival_date->format('Y-m-d'));
      $current_date = new DateTime(date('Y-m-d'));
      //dd($arrival_date);
      $rentDays = $arrival_date->diff($current_date);
      $data['rentDays'] = $rentDays->days;
      $data['arrivalDate'] = $data->arrival_date->format('Y-m-d');
