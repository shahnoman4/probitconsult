...
class AdminSidebarMenu
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        Menu::create('admin-sidebar-menu', function ($menu) {
            ...
            //Vessel menu
            if (auth()->user()->can('vessel')) {
                $menu->url(action([\App\Http\Controllers\VesselController::class, 'index']), __('vessel.vessels'), ['icon' => 'fa fas fa-hdd', 'active' => request()->segment(1) == 'vessel'])->order(60);
            }
