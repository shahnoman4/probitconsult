...
<input type="hidden" id="item_addition_method" value="{{$business_details->item_addition_method}}">
	...
	<div class="row">
		<div class="col-md-12 col-sm-12">
			@component('components.widget', ['class' => 'box-solid'])
				...
				<div class="col-sm-3">
					<div class="form-group">
						{!! Form::label('vessel_id', __('vessel.vessels') . ':*' ) !!}
						<div class="input-group">
							<span class="input-group-addon">
								<i class="fa fa-info"></i>
							</span>
							{!! Form::select('vessel_id', $vessel, 'percentage' , ['class' => 'form-control vessel_id','placeholder' => __('messages.please_select'), 'required', 'data-default' => 'percentage']); !!}
						</div>
					</div>
				</div>
				<div class="clearfix"></div>	
				...
				@endif
					...
					<div class="col-sm-4">
						<div class="form-group">
							{!! Form::label('upload_document', __('sale.customs_declaration') . ':') !!}
							{!! Form::file('sell_document', ['id' => 'upload_document2', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
							<p class="help-block">
								@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
								@includeIf('components.document_help_text')
							</p>
					...
					<div class="col-sm-4">
						<div class="form-group">
							{!! Form::label('upload_document', __('sale.packing_list') . ':') !!}
							{!! Form::file('sell_document', ['id' => 'upload_document3', 'accept' => implode(',', array_keys(config('constants.document_upload_mimes_types')))]); !!}
							<p class="help-block">
								@lang('purchase.max_file_size', ['size' => (config('constants.document_size_limit') / 1000000)])
								@includeIf('components.document_help_text')
							</p>
			...
			@component('components.widget', ['class' => 'box-solid'])
				<div class="col-sm-10 col-sm-offset-1">
					<div class="form-group">
						<p class="vessel_rent" style="display:none"></p>
					</div>
				</div>
				<div class="col-sm-10 col-sm-offset-1">
					<div class="form-group">
	...
	<input type="number" name="rent_days_value" id="rent_days_value" value="1">
...
@section('javascript')
    ...
    <script type="text/javascript">
    	$(document).ready( function() {
			...
			var id = $(this).val();
			$.ajax({
			"url": "{{ url('/sells/vesselCalculation') }}",
			type: "POST",
